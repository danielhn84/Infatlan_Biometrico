    ...
    public partial class solicitudTE : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
                ...
                {
                    TituloPagina.Text = "Aprobación Solicitud Tiempo Extraordinario";
        ...
        void validacionInicioTurno()
        {
            ...
            //    throw new Exception("Debe ingresar la solicitud hasta el dia de mañana, debe esperar que finalice todo el ciclo de la jornada para que pueda visualizar las entradas, salidas, disminución de entradas tarde, salidas tempranas y disminucion de almuerzo.");
            ...
            if ((vHIS > vHIT && vHIS < vHFT) && STEDIASTURNO == "L-V" && (dia == "lunes" || dia == "martes" || dia == "miercoles" || dia == "jueves" || dia == "viernes"))
            {
            ...
            else if ((vHIS > vHIT && vHIS < vHFT) && STEDIASTURNO == "L-D" && (dia == "lunes" || dia == "martes" || dia == "miercoles" || dia == "jueves" || dia == "viernes" || dia == "sabado" || dia == "domingo"))
            {
                throw new Exception("Hemos detectado un traslape con su hora inicial de solicitud: " + vHIS.ToString("dd/MM/yyyy HH:mm:ss") + ". Su turno asignado o si realizo cambio es: " + Session["STETURNO"].ToString() + " , favor verificar que su hora inicial de solicitud sea menor que su hora inicio turno o su hora inicial de solicitud sea mayor que su hora final de turno");
            }
            else if ((vHIS > vHIT && vHIS < vHFT) && STEDIASTURNO == "L-M-V-D" && (dia == "lunes" || dia == "miercoles" || dia == "viernes" || dia == "domingo"))
            {
                throw new Exception("Hemos detectado un traslape con su hora inicial de solicitud: " + vHIS.ToString("dd/MM/yyyy HH:mm:ss") + ". Su turno asignado o si realizo cambio es: " + Session["STETURNO"].ToString() + " , favor verificar que su hora inicial de solicitud sea menor que su hora inicio turno o su hora inicial de solicitud sea mayor que su hora final de turno");
            }
        ...
        {
            Session["STEAPROBACIONSUBGERENTE"] = "no";
            //string vEstadoAprobacionSubgerente = "no";
            DateTime vtoday = DateTime.Now;           
            ...
            if ( Session["STESUBGERENCIA"].ToString().Equals("4") || Session["STESUBGERENCIA"].ToString().Equals("2"))
            {
                ...
                {
                    Session["STEAPROBACIONSUBGERENTE"] = "si";
            ...
            if ((vHFS > vHIT && vHFS < vHFT) && STEDIASTURNO == "L-V" && (dia == "lunes" || dia == "martes" || dia == "miercoles" || dia == "jueves" || dia == "viernes"))
            {
            ...
            else if ((vHFS > vHIT && vHFS < vHFT) && STEDIASTURNO == "L-D" && (dia == "lunes" || dia == "martes" || dia == "miercoles" || dia == "jueves" || dia == "viernes" || dia == "sabado" || dia == "domingo"))
            {
                throw new Exception("Hemos detectado un traslape con su hora inicial de solicitud: " + vHFS.ToString("dd/MM/yyyy HH:mm:ss") + " del turno asignado o si realizo cambio: " + Session["STETURNO"].ToString() + " , favor verificar que su hora inicial de solicitud sea menor que su hora inicio turno o su hora inicial de solicitud sea mayor que su hora final de turno");
            }
            else if ((vHFS > vHIT && vHFS < vHFT) && STEDIASTURNO == "L-M-V-D" && (dia == "lunes" || dia == "miercoles" || dia == "viernes" || dia == "domingo"))
            {
                throw new Exception("Hemos detectado un traslape con su hora inicial de solicitud: " + vHFS.ToString("dd/MM/yyyy HH:mm:ss") + " del turno asignado o si realizo cambio: " + Session["STETURNO"].ToString() + " , favor verificar que su hora inicial de solicitud sea menor que su hora inicio turno o su hora inicial de solicitud sea mayor que su hora final de turno");
            }
        }
        ...
        void calculoHoras()
        {
            if (TxFechaInicio.Text != "" && TxFechaRegreso.Text != "")
            {
                ...
                else if (vTimeHEB > vTimeHIT)
                {
                    ...
                    vCantidadRealDescontarEntrada = "TIEMPO TOTAL A DESCONTAR SIN PERMISOS REINTEGRADOS: " + vDescontarEntradaTarde;
                ...
                else if (vTimeHSB < vTimeHFT && dias == 0)
                {
                    ...
                    vCantidadRealDescontar = "TIEMPO TOTAL A DESCONTAR SIN PERMISOS REINTEGRADOS: " + vDescontarSalidaTemprana;
        ...
        private void validacionesCrearSolicitud()
        {
            ...
            if(Session["STEAPROBACIONSUBGERENTE"].ToString()=="si" && DdlMotivoAprobacionSubgerente.SelectedValue.Equals("0"))
            ...
            if (Session["STEAPROBACIONSUBGERENTE"].ToString() == "si" && TxSoliAprobacionSubGerente.Text.Equals(""))
            ...
            if (Convert.ToInt32(cantSysAid) > 0)
                throw new Exception("Usted ya tiene ingresada una solicitud de tiempo extraordinario con el mismo número de SysAid: " + TxPeticion.Text + ".");
        ...
        protected void BtnEnviarSolicitud_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (vRespuesta == 1)
                {
                    vRe = "Se ha creado con exito la solicitud de tiempo extraordinado.";
                    Mensaje(vRe, WarningType.Success);
                }

                else
                {
                    vRe = "No se pudo crear la solicitud de tiempo extraordinario, pongase en contacto con el administrador de la plataforma.";
                    Mensaje(vRe, WarningType.Warning);
                }
        ...
        protected void BtnDescargarArchivo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (vEx == null)
                {
                    ...
                    String vQuery = "RSP_TiempoExtraordinarioGenerales 12," + Session["USUARIO"] + "," + vIdSolicitud;
                    DataTable vDatos = vConexion.obtenerDataTable(vQuery);
        ...
        protected void BtnAprobarJefeModal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (vRespuesta == 1)
                {
                    vRe = "Respuesta enviado con exito.";
                    Mensaje(vRe, WarningType.Success);
                }
                else
                {
                    vRe = "No se pudo enviar la respuesta, pongase en contacto con el administrador de la plataforma.";
                    Mensaje(vRe, WarningType.Warning);
                }
        ...
        protected void BtnAprobarRrhhModal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (vRespuesta == 1)
                {
                    vRe = "Se ha enviado con exito la respuesta de RRHH de la solicitud de tiempo extraordinado.";
                    Mensaje(vRe, WarningType.Success);

                    LimpiarAprobacionRRHH();
                    ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "Pop", "closeAprobarRRHHModal();", true);
                    Response.Redirect("/pages/tiempoExtraordinario/pendientesAprobarRRHH.aspx");
                }

                else
                {
                    vRe = "No se pudo actualizar la aprobacion de la solicitud de tiempo extraordinario, pongase en contacto con el administrador de la plataforma.";
                    Mensaje(vRe, WarningType.Warning);
                }
