<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="motioViaje.aspx.cs" Inherits="BiometricoWeb.pages.mantenimiento.motioViaje" %>
    ...
    <div class="row">
     ...
     <nav>
        <div class="nav nav-pills " id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="nav-solicitud-tab" data-toggle="tab" href="#nav-solicitud" role="tab" aria-controls="nav-home" aria-selected="true"><i class="mdi mdi-book"></i>Lista de motivos</a>
     ...
     <div class="tab-content" id="nav-tabContent">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Buscar motivos</h4>

                    <asp:UpdatePanel ID="UPBuscarTra" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>   
                            <div class="row col-12">
                                    <asp:TextBox ID="txtbuscarMotivos" OnTextChanged="txtbuscarMotivos_TextChanged" runat="server" placeholder="ingrese transporte - Presione afuera para proceder" CssClass="form-control col-10" AutoPostBack="true"></asp:TextBox>
                                    <asp:LinkButton Text="Nuevo" runat="server" ID="btnNewMotivo" OnClick="btnNewMotivo_Click" CssClass="btn btn-info col-2" />                                
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                ...
                <ContentTemplate>
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                           <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Lista de motivos</h4>
                                                     ...
                                                     <asp:GridView ID="GVSolicitud" runat="server"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnAprobar" runat="server" Text="" class="btn btn-inverse-primary mr-2" CommandArgument='<%# Eval("ID") %>' CommandName="Crear">
                                                             ...
                                                             <asp:BoundField DataField="Motivo" HeaderText="Transporte" Visible="true" ItemStyle-HorizontalAlign="center" />
                                                            <asp:BoundField DataField="Estado" HeaderText="Estado" Visible="false" ItemStyle-HorizontalAlign="center" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel4">¿Desea crear motivo de viaje?</h4>
                    </div>
                                    ...
                                    <%--<div class="row">--%>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Motivo de viaje</label>
                                                <div class="col-sm-11">
                                                    <asp:TextBox runat="server" ID="txtModalMotivo" CssClass="form-control"/>
                                                </div>
                                            </div>
                                        </div>     
                                 </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                        <ContentTemplate>
                            <div class="modal-footer col-12">
                               <div class="row col-3">
                                    <asp:Button runat="server" ID="btnCrearMotivo" OnClick="btnCrearMotivo_Click" CssClass="btn btn-success mr-3" Text="Crear" />
                               </div>
                                <div class="row col-3">
                                    <asp:Button runat="server" ID="btnCerrarMotivo" OnClick="btnCerrarMotivo_Click" CssClass="btn btn-danger mr-3" Text="Cancelar" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
     ...
     <!--MODAL MOD MOTIVO-->
        <div class="modal bs-example-modal-lg" id="modalModificar" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel2">¿Desea modificar motivo de viaje?</h4>
                    </div>
                                    ...
                                    <%--<div class="row">--%>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Motivo de viaje</label>
                                                <div class="col-sm-11">
                                                    <asp:TextBox runat="server" ID="txtModalModificarMotivo" CssClass="form-control"/>
                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Estado</label>
                                                <div class="col-sm-11">
                                                    <asp:DropDownList runat="server" ID="DDLModalEstado" CssClass="form-control">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <div class="modal-footer col-12">
                               <div class="row col-3">
                                    <asp:Button runat="server" ID="btnModificarMotivo" OnClick="btnModificarMotivo_Click" CssClass="btn btn-success mr-3" Text="Modificar" />
                               </div>
                                <div class="row col-3">
                                    <asp:Button runat="server" ID="btnCerrarModMotivo" OnClick="btnCerrarModMotivo_Click" CssClass="btn btn-danger mr-3" Text="Cancelar" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
