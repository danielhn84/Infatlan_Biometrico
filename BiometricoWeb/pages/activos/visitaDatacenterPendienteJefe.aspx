<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="visitaDatacenterPendienteJefe.aspx.cs" Inherits="BiometricoWeb.pages.activos.visitaDatacenterPendienteJefe" %>
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>Solicitudes Pendientes Aprobar Jefe</h2>
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Solicitudes que no han sido autorizados por los jefes.</p>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="TxSolicitud" runat="server" placeholder="Busqueda por Solicitud o Responsable- Presione afuera para proceder" class="form-control" AutoPostBack="true" OnTextChanged="TxSolicitud_TextChanged"></asp:TextBox>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="GVBusquedaPendientesJefe" runat="server"
                                        ...
                                        AllowPaging="true"  OnRowCommand="GVBusquedaPendientesJefe_RowCommand"
