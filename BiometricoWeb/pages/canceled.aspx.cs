    ...
    public partial class canceled : System.Web.UI.Page
    {
        ...
        void CargarAutorizaciones(){
            try{
                ...
                Session["DATOSAUTORIZAR_CANCELADOS"] = vDatos;
        ...
        protected void TxBuscarEmpleado_TextChanged(object sender, EventArgs e){
            try{
                ...
                DataTable vDatos = (DataTable)Session["DATOSAUTORIZAR_CANCELADOS"];
                ...
                if (vBusqueda.Equals("")){
                    ...
                    GVBusqueda.DataBind();
                    Session["DATOSAUTORIZAR_CANCELADOS"] = vDatosFiltrados;
                    UpdateGridView.Update();
                }
        ...
        protected void GVBusqueda_PageIndexChanging(object sender, GridViewPageEventArgs e){
            try{
                ...
                GVBusqueda.DataSource = (DataTable)Session["DATOSAUTORIZAR_CANCELADOS"];
                GVBusqueda.DataBind();
