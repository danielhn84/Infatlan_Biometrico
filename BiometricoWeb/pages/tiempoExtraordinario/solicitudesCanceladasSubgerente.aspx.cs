...
{
    public partial class solicitudesCanceladasSubgerente : System.Web.UI.Page
    {
        db vConexion;
        ...
        protected void GVBusquedaCanceladasSubgerente_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void GVBusquedaCanceladasSubgerente_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                String vQuery = "RSP_TiempoExtraordinarioGenerales 37," + vIdSolicitud;
                DataTable vDatos = vConexion.obtenerDataTable(vQuery);
