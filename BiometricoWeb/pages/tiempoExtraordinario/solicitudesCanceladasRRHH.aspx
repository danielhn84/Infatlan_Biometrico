...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>Solicitudes Canceladas RRHH</h2>
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Ordenados por fecha de cancelacion</p>
                    <div class="col-md-6">
    ...
    <%-- SECCION 2---%>
    <asp:UpdatePanel ID="UpBusquedaCanceladasRRHH" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="GVBusquedaCanceladasRRHH" runat="server"
                                        CssClass="mydatagrid"
                                        PagerStyle-CssClass="pgr"
                                        HeaderStyle-CssClass="header"
                                        RowStyle-CssClass="rows"
                                        AutoGenerateColumns="false"
                                        AllowPaging="true" OnRowCommand="GVBusquedaCanceladasRRHH_RowCommand"
                                        GridLines="None" OnRowDataBound="GVBusquedaCanceladasRRHH_RowDataBound"
                                        PageSize="10" OnPageIndexChanging="GVBusquedaCanceladasRRHH_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="aprobadas" HeaderText="Hrs Aprobadas" />
                                            ...
                                            <asp:BoundField DataField="horaRrhhAprobo" HeaderText="Cancelo RRHH" />
                                            <asp:BoundField DataField="observacionRrhh" HeaderText="Motivo Cancelación"  ItemStyle-HorizontalAlign="Justify"/>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 600px; top: 320px; left: 50%; transform: translate(-50%, -50%);">
                ...
                <div class="modal-body">
                    ...
                    <asp:UpdatePanel ID="UpdateMensaje" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="form-group row">
                                <asp:Label ID="LbMsgMasInformacion" runat="server" Text="" Class="col-sm-12" Style="color: black; text-align: justify;"></asp:Label>
