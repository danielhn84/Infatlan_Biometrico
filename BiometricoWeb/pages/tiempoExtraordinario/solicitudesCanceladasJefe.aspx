<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="solicitudesCanceladasJefe.aspx.cs" Inherits="BiometricoWeb.pages.tiempoExtraordinario.solicitudesCanceladasJefe" %>
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>Solicitudes Canceladas Jefes</h2>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="GVBusquedaCanceladasJefes" runat="server"
                                        CssClass="mydatagrid"
                                        PagerStyle-CssClass="pgr"
                                        HeaderStyle-CssClass="header"
                                        RowStyle-CssClass="rows"
                                        AutoGenerateColumns="false" 
                                        AllowPaging="true"   OnRowCommand="GVBusquedaCanceladasJefes_RowCommand"
                                        GridLines="None"  OnPageIndexChanging="GVBusquedaCanceladasJefes_PageIndexChanging"
                                        PageSize="10"   OnRowDataBound="GVBusquedaCanceladasJefes_RowDataBound" >
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="horaJefeAprobo" HeaderText="Cancelo Jefe" />
                                            <asp:BoundField DataField="motivoCancelacionJefe" HeaderText="Motivo" />
