<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="proyectos.aspx.cs" Inherits="BiometricoWeb.pages.tiempoExtraordinario.proyectos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav>
        <div class="nav nav-pills " id="nav-tab" role="tablist">
            <a class="nav-item nav-link active" id="nav-datos-tab" data-toggle="tab" href="#nav-crearProyecto" role="tab" aria-controls="nav-home" aria-selected="true"><i class="mdi mdi-plus"></i>Proyecto</a>
            <a class="nav-item nav-link" runat="server" visible="true" id="nav_ListaProyecto_tab" data-toggle="tab" href="#nav-tecnicos" role="tab" aria-controls="nav-profile" aria-selected="false"><i class="mdi mdi-book"></i>Mis Proyectos</a>
        </div>
    </nav>
    ...
    <div class="tab-content" id="nav-tabContent">
        <br />
        <%--PRIMERA PARTE--%>
        <div class="tab-pane fade show active" id="nav-crearProyecto" role="tabpanel" aria-labelledby="nav-datos-tab">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><b>Creación de Proyecto</b> </h4>
                            <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <asp:TextBox ID="TxProyecto" placeholder="" class="form-control" runat="server" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
        ...
        <div class="tab-pane fade" id="nav-tecnicos" role="tabpanel" aria-labelledby="nav-tecnicos-tab">
            <asp:UpdatePanel ID="UpdateDivProyecto" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GVBusquedaProyecto" runat="server"
                                                CssClass="mydatagrid"
                                                PagerStyle-CssClass="pgr"
                                                HeaderStyle-CssClass="header"
                                                RowStyle-CssClass="rows"
                                                AutoGenerateColumns="false"
                                                AllowPaging="true" OnRowCommand="GVBusquedaProyecto_RowCommand"
                                                GridLines="None" OnPageIndexChanging="GVBusquedaProyecto_PageIndexChanging"
                                                PageSize="10">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="idTipoTrabajoDescripcion" HeaderText="Id. Proyecto" />
                                                    <asp:BoundField DataField="nombreTrabajo" HeaderText="Proyecto" ItemStyle-HorizontalAlign="Left" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 600px; top: 320px; left: 50%; transform: translate(-50%, -50%);">
                <div class="modal-header">
                    <h4 class="modal-title">Creación Proyecto</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Proyecto</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="TxProyectoModal" placeholder="" class="form-control" runat="server" TextMode="MultiLine" Rows="2"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
