...
{
    public partial class solicitudesAprobadasJefe : System.Web.UI.Page
    {
        db vConexion;
        ...
        {
            vConexion = new db();
            cargarSolicitudesAprobadasJefe();
        }
        void cargarSolicitudesAprobadasJefe()
        {
            try
            {         
                ...
                GVBusquedaAprobadasJefes.DataBind();
                UpBusquedaAprobadasJefes.Update();
                Session["STESOLICITUDESAPROBADASJEFE"] = vDatos;
            }
            catch (Exception Ex) { Mensaje(Ex.Message, WarningType.Danger); }
        }
        protected void GVBusquedaAprobadasJefes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void GVBusquedaAprobadasJefes_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                GVBusquedaAprobadasJefes.PageIndex = e.NewPageIndex;
                GVBusquedaAprobadasJefes.DataSource = (DataTable)Session["STESOLICITUDESAPROBADASJEFE"];
                GVBusquedaAprobadasJefes.DataBind();
                UpBusquedaAprobadasJefes.Update();
            }
            catch (Exception Ex) { Mensaje(Ex.Message, WarningType.Danger); }
        }
        protected void GVBusquedaAprobadasJefes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        protected void TxBuscarEmpleado_TextChanged(object sender, EventArgs e)
        {
            ...
            DataTable vDatos = (DataTable)Session["STESOLICITUDESAPROBADASJEFE"];
            ...
            else
            {
                ...
                GVBusquedaAprobadasJefes.DataSource = vDatosFiltrados;
                GVBusquedaAprobadasJefes.DataBind();
                Session["STESOLICITUDESAPROBADASJEFE"] = vDatosFiltrados;
                UpBusquedaAprobadasJefes.Update();
            }
        }
