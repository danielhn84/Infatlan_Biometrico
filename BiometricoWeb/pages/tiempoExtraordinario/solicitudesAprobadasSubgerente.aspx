<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="solicitudesAprobadasSubgerente.aspx.cs" Inherits="BiometricoWeb.pages.tiempoExtraordinario.solicitudesAprobadasSubgerente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>Solicitudes Aprobadas Subgerente</h2>
    ...
    <%-- SECCION 2---%>
    <asp:UpdatePanel ID="UpBusquedaAprobadasSubgerente" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="GVBusquedaAprobadasSubgerente" runat="server"
                                        CssClass="mydatagrid"
                                        PagerStyle-CssClass="pgr"
                                        HeaderStyle-CssClass="header"
                                        RowStyle-CssClass="rows"
                                        AutoGenerateColumns="false"
                                        AllowPaging="true" OnRowCommand="GVBusquedaAprobadasSubgerente_RowCommand"
                                        GridLines="None" OnPageIndexChanging="GVBusquedaAprobadasSubgerente_PageIndexChanging"
                                        PageSize="10" OnRowDataBound="GVBusquedaAprobadasSubgerente_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="horaAproboSubgerente" HeaderText="Aprobo Subgerente" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
